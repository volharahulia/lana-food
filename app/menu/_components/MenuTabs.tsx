...
// Just the tab strip — the active/onChange Radix Tabs.Root now lives in
// MenuExperience.tsx (it wraps the panel content too, so Tabs.Content can sit
// under the same Tabs.Root per Radix's requirements). Tabs.List/Tabs.Trigger
// read their active state from that ancestor Tabs.Root via context, so
// nesting them one level deeper here (inside the sticky wrapper div) doesn't
// need any value/onValueChange of their own.
//

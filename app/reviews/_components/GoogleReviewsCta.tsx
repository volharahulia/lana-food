...
// no longer duplicates them) — both resolve to the single configurable
// business.googleBusinessProfile destination.
export default function GoogleReviewsCta() {
  const { googleBusinessProfile } = business;
      ...
      >
        ...
        <div className="flex w-full flex-col items-stretch gap-3 laptop:w-auto laptop:shrink-0">
          {googleBusinessProfile ? (
            <Button href={googleBusinessProfile} target="_blank" rel="noopener noreferrer" size="md">
